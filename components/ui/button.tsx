...
const VARIANT_CLASSES: Record<ButtonVariant, string> = {
  ...
  secondary:
    "bg-surface text-primary border border-border-strong hover:bg-surface-subtle hover:border-secondary",
  ghost: "bg-transparent text-secondary border border-transparent hover:bg-surface-subtle hover:text-primary",
